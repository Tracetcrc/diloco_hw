...
def save_streaming_diloco_checkpoint(
    ...
    serializable_shard_tracker = _serialize_shard_tracker(shard_tracker, save_model_only, include_old_sent=False)
...
def save_dc_diloco_checkpoint(
    ...
    # 准备要保存的shard_tracker状态 - 需要特殊处理其中的tensor
    serializable_shard_tracker = _serialize_shard_tracker(shard_tracker, save_model_only, include_old_sent=True)
